...
namespace ServiceBusTests.OrderService {
    ...
    public interface IOrderService {
        ...
        ServiceBusTests.OrderService.CreateNewOrderResponse CreateNewOrder(ServiceBusTests.OrderService.CreateNewOrderRequest request);
        ...
        ServiceBusTests.OrderService.CreatePDFDocumentResponse CreatePDFDocument(ServiceBusTests.OrderService.CreatePDFDocumentRequest request);
        
        // CODEGEN: Generating message contract since the operation has multiple return values.
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IOrderService/CreatePDFDocument", ReplyAction="http://tempuri.org/IOrderService/CreatePDFDocumentResponse")]
        System.Threading.Tasks.Task<ServiceBusTests.OrderService.CreatePDFDocumentResponse> CreatePDFDocumentAsync(ServiceBusTests.OrderService.CreatePDFDocumentRequest request);
        ...
        ServiceBusTests.OrderService.GetOrderStateResponse GetOrderState(ServiceBusTests.OrderService.GetOrderStateRequest request);
        
        // CODEGEN: Generating message contract since the operation has multiple return values.
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IOrderService/GetOrderState", ReplyAction="http://tempuri.org/IOrderService/GetOrderStateResponse")]
        System.Threading.Tasks.Task<ServiceBusTests.OrderService.GetOrderStateResponse> GetOrderStateAsync(ServiceBusTests.OrderService.GetOrderStateRequest request);
    }
    ...
    public partial class OrderServiceClient : System.ServiceModel.ClientBase<ServiceBusTests.OrderService.IOrderService>, ServiceBusTests.OrderService.IOrderService {
        ...
        ServiceBusTests.OrderService.CreateNewOrderResponse ServiceBusTests.OrderService.IOrderService.CreateNewOrder(ServiceBusTests.OrderService.CreateNewOrderRequest request) {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        ServiceBusTests.OrderService.CreatePDFDocumentResponse ServiceBusTests.OrderService.IOrderService.CreatePDFDocument(ServiceBusTests.OrderService.CreatePDFDocumentRequest request) {
        ...
        public SharedLibs.DataContracts.Result CreatePDFDocument(SharedLibs.DataContracts.User user, SharedLibs.DataContracts.Order order, SharedLibs.Enums.PDFDocumentType documentType, out string pdfFilePath) {
            ServiceBusTests.OrderService.CreatePDFDocumentRequest inValue = new ServiceBusTests.OrderService.CreatePDFDocumentRequest();
            inValue.user = user;
            inValue.order = order;
            inValue.documentType = documentType;
            ServiceBusTests.OrderService.CreatePDFDocumentResponse retVal = ((ServiceBusTests.OrderService.IOrderService)(this)).CreatePDFDocument(inValue);
            pdfFilePath = retVal.pdfFilePath;
            return retVal.CreatePDFDocumentResult;
        }
        
        public System.Threading.Tasks.Task<ServiceBusTests.OrderService.CreatePDFDocumentResponse> CreatePDFDocumentAsync(ServiceBusTests.OrderService.CreatePDFDocumentRequest request) {
            return base.Channel.CreatePDFDocumentAsync(request);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        ServiceBusTests.OrderService.GetOrderStateResponse ServiceBusTests.OrderService.IOrderService.GetOrderState(ServiceBusTests.OrderService.GetOrderStateRequest request) {
        ...
        public SharedLibs.DataContracts.Result GetOrderState(SharedLibs.Enums.OrderStateType orderStateType, out System.Guid orderState) {
            ServiceBusTests.OrderService.GetOrderStateRequest inValue = new ServiceBusTests.OrderService.GetOrderStateRequest();
            inValue.orderStateType = orderStateType;
            ServiceBusTests.OrderService.GetOrderStateResponse retVal = ((ServiceBusTests.OrderService.IOrderService)(this)).GetOrderState(inValue);
            orderState = retVal.orderState;
            return retVal.GetOrderStateResult;
        }
        
        public System.Threading.Tasks.Task<ServiceBusTests.OrderService.GetOrderStateResponse> GetOrderStateAsync(ServiceBusTests.OrderService.GetOrderStateRequest request) {
